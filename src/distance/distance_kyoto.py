...
file_path = "2023_YJ_MI_MA/result_4_1_model_figure_4/kyoto/"
...
def draw_conditional_probability(x, y):
    ...
    plt.yticks([0, 0.006, 0.012], ["0", "0.006", "0.012"], fontsize=ft)
    plt.ylabel('P(Go|Search)', fontsize=ft)

    plt.title("Kyoto")
    #plt.legend(loc=1, fontsize=8)
    plt.savefig('p-distance-kyoto-20260504.svg',bbox_inches = 'tight')
    plt.show()
