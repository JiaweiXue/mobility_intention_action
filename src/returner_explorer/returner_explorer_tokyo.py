...
user_type_1 = folder + "result_7_returner_explorer/tokyo/return_explorer/return_explorer_0_100000.json"
user_type_2 = folder + "result_7_returner_explorer/tokyo/return_explorer/return_explorer_100000_200000.json"
user_type_3 = folder + "result_7_returner_explorer/tokyo/return_explorer/return_explorer_200000_300000.json"

user_go_search = folder + "result_7_returner_explorer/tokyo/res_sg/user_sg_sng_nsg_nsng_dict_30w_90days_"
...
with open(user_type_2, 'r') as f:
    df_user_type_2 = json.load(f)
    for user in df_user_type_2:
        df_user_type[user] = df_user_type_2[user]

with open(user_type_3, 'r') as f:
    df_user_type_3 = json.load(f)
    for user in df_user_type_3:
        df_user_type[user] = df_user_type_3[user]
...
plt.ylim(0, 0.012)
plt.yticks([0, 0.004, 0.008, 0.012], ['0', '0.004', '0.008', '0.012'])

plt.axvline(x=0.52,color='black', ymin = 0, ymax = 1, linestyle='--', linewidth=1.5)
plt.text(0.38, -0.0009, '0.5', fontsize=10, color="black")
plt.text(0.65, 0.0108, 'Explorer', fontsize=ft, color="black")
plt.text(1.4, 0.007, 'Returner', fontsize=ft, color="black")

plt.title("Tokyo", fontsize=ft)
plt.savefig('20260308_tokyo_p_go_search_2.svg',bbox_inches = 'tight')
plt.savefig('20260308_tokyo_p_go_search_2.png',bbox_inches = 'tight')
...
plt.title("Tokyo", fontsize=ft)
plt.savefig('20260308_tokyo_p_go_search_4.svg',bbox_inches = 'tight')
plt.savefig('20260308_tokyo_p_go_search_4.png',bbox_inches = 'tight')
...
plt.title("Tokyo", fontsize=ft)
plt.savefig('20260308_tokyo_p_go_search_8.svg',bbox_inches = 'tight')
plt.savefig('20260308_tokyo_p_go_search_8.png',bbox_inches = 'tight')
